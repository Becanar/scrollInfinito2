...
class MainActivity : AppCompatActivity() {
    ...
    /**
     * Método que configura el gesto de deslizar para eliminar tareas del RecyclerView.
     * Utiliza un ItemTouchHelper para gestionar los eventos de deslizamiento y permite
     * a los usuarios eliminar tareas deslizando hacia la izquierda o hacia la derecha.
     */
